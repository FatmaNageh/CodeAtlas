...
import type { CodeNode } from "../../../../packages/api/src/types/codeNode.d";
      ...
      <div className="max-h-40 overflow-y-auto pr-2">
        <ul className="space-y-1.5">
          {items.map((item, index) => (
            <li
              key={index}
              className="bg-gray-700/50 p-2 rounded-md text-sm font-mono wrap-break-word text-gray-300 shadow-sm"
            >
              {cleanItem(item)}
            </li>
          ))}
