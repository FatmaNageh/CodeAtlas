...
function GraphViewer() {
  ...
  return (
    <div style={{width: '100vw', height: '100vh', minHeight: 0, minWidth: 0, overflow: 'hidden', background: '#18181b', display: 'flex', flexDirection: 'column'}}>
      {/* Node Color Legend - bottom left, floating */}
      <div style={{
        position: 'fixed',
        left: 24,
        bottom: 24,
      ...
      {/* Controls Bar - always at the top, full width */}
      {!controlsCollapsed && (
      ...
      <div style={{
        ...
        {mode === "neo4j" && neo && (
          <Neo4jGraph nodes={neo.nodes} edges={neo.edges} onNodeClick={() => {}} />
        )}
      </div>
    </div>
  );
